...
"""abydos.distance._positional_q_gram_dice.
...
class PositionalQGramDice(_Distance):
    r"""Positional Q-Gram Dice coefficient.

    Positional Q-Gram Dice coefficient :cite:`Gravano:2001,Christen:2006`
    ...
    def sim(self, src: str, tar: str) -> float:
        ...
        denom = len(src_list) + len(tar_list)
