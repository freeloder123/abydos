...
cmp_no_d = UnknownA(alphabet=0)


def test_unknown_a_sim():
...
def test_unknown_a_dist():
    """Test abydos.distance.UnknownA.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
...
def test_unknown_a_corr():
    """Test abydos.distance.UnknownA.corr."""
    # Base cases
    assert cmp.corr('', '') == 1.0
