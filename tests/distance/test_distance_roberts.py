...
"""abydos.tests.distance.test_distance_roberts.

This module contains unit tests for abydos.distance.Roberts
"""


import pytest

from abydos.distance import Roberts


cmp = Roberts()


def test_roberts_sim():
    """Test abydos.distance.Roberts.sim."""
    # Base cases
    assert cmp.sim('', '') == 1.0
...
def test_roberts_dist():
    """Test abydos.distance.Roberts.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
