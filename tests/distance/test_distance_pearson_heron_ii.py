...
cmp_no_d = PearsonHeronII(alphabet=0)


def test_pearson_heron_ii_sim():
    ...
    assert cmp.sim('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.9915587467)
    assert cmp.sim('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.9915587467)
    assert cmp.sim('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.9915587467)
    assert cmp.sim('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.9915587467)
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.9949989546)
...
def test_pearson_heron_ii_dist():
    """Test abydos.distance.PearsonHeronII.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
    ...
    assert cmp.dist('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.0084412533)
    assert cmp.dist('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.0084412533)
    assert cmp.dist('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.0084412533)
    assert cmp.dist('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.0084412533)
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.0050010454)
...
def test_pearson_heron_ii_corr():
    """Test abydos.distance.PearsonHeronII.corr."""
    # Base cases
    assert cmp.corr('', '') == 1.0
    ...
    assert cmp.corr('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.9831174935)
    assert cmp.corr('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.9831174935)
    assert cmp.corr('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.9831174935)
    assert cmp.corr('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.9831174935)
    assert cmp.corr('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.9899979092)
