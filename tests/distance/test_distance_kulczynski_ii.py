...
"""abydos.tests.distance.test_distance_kulczynski_ii.

This module contains unit tests for abydos.distance.KulczynskiII
"""


import pytest

from abydos.distance import KulczynskiII


cmp = KulczynskiII()


def test_kulczynski_ii_sim():
    """Test abydos.distance.KulczynskiII.sim."""
    # Base cases
    assert cmp.sim('', '') == 1.0
...
def test_kulczynski_ii_dist():
    """Test abydos.distance.KulczynskiII.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
