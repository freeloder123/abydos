...
"""abydos.tests.distance.test_distance_maxwell_pilliner.

This module contains unit tests for abydos.distance.MaxwellPilliner
"""


import pytest

from abydos.distance import MaxwellPilliner


cmp = MaxwellPilliner()

cmp_no_d = MaxwellPilliner(alphabet=0)


def test_maxwell_pilliner_sim():
    """Test abydos.distance.MaxwellPilliner.sim."""
    # Base cases
    assert cmp.sim('', '') == 0.5
...
def test_maxwell_pilliner_dist():
    """Test abydos.distance.MaxwellPilliner.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.5
...
def test_maxwell_pilliner_corr():
    """Test abydos.distance.MaxwellPilliner.corr."""
    # Base cases
    assert cmp.corr('', '') == 0.0
