...
def test_kuhns_vi_sim():
    ...
    assert cmp.sim('abcd', 'efgh') == pytest.approx(abs=1e-7, expected=0.496790757381258)
    ...
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.8474160207)
    ...
    assert cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.3181818182)

def test_kuhns_vi_dist():
    ...
    assert cmp.dist('abcd', 'efgh') == pytest.approx(abs=1e-7, expected=0.503209242618742)
    ...
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.1525839793)
    ...
    assert cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.6818181818)

def test_kuhns_vi_corr():
    ...
    assert cmp.corr('abcd', 'efgh') == pytest.approx(abs=1e-7, expected=-0.006418485237484)
    ...
    assert cmp.corr('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.6948320413)
    ...
    assert cmp_no_d.corr('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=-0.3636363636)
