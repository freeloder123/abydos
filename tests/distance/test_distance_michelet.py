...
"""abydos.tests.distance.test_distance_michelet.

This module contains unit tests for abydos.distance.Michelet
"""


import pytest

from abydos.distance import Michelet


cmp = Michelet()


def test_michelet_sim():
    """Test abydos.distance.Michelet.sim."""
    # Base cases
    assert cmp.sim('', '') == 1.0
...
def test_michelet_dist():
    """Test abydos.distance.Michelet.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
