...
def test_doolittle_sim():
    ...
    assert cmp.sim('abcd', 'efgh') == 4.1196952743799446e-05

    assert cmp.sim('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.2461588279)
    assert cmp.sim('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.2461588279)
    assert cmp.sim('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.2461588279)
    assert cmp.sim('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.2461588279)
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.439469213)
    ...
    assert cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.1090909091)

def test_doolittle_dist():
    ...
    assert cmp.dist('abcd', 'efgh') == 0.9999588030472562

    assert cmp.dist('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.7538411721)
    assert cmp.dist('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.7538411721)
    assert cmp.dist('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.7538411721)
    assert cmp.dist('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.7538411721)
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.560530787)
    ...
    assert cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.8909090909)
