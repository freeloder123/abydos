...
def test_baulieu_v_dist():
    ...
    assert cmp.dist('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.7)
    assert cmp.dist('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.7)
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.5333333333)

def test_baulieu_v_sim():
    ...
    assert cmp.sim('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.3)
    assert cmp.sim('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.3)
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.4666666667)
