...
def test_consonni_todeschini_iii_sim():
    ...
    assert cmp.sim('', 'abc') == 0.0
    assert cmp.sim('abc', 'abc') == 0.24145128700608987
    assert cmp.sim('abcd', 'efgh') == 0.0

    assert cmp.sim('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.2079748185)
    assert cmp.sim('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.2079748185)
    assert cmp.sim('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.2079748185)
    assert cmp.sim('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.2079748185)
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.3119622277)
...
def test_consonni_todeschini_iii_dist():
    ...
    assert cmp.dist('', 'abc') == 1.0
    assert cmp.dist('abc', 'abc') == 0.7585487129939101
    assert cmp.dist('abcd', 'efgh') == 1.0

    assert cmp.dist('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.7920251815)
    assert cmp.dist('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.7920251815)
    assert cmp.dist('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.7920251815)
    assert cmp.dist('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.7920251815)
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.6880377723)
