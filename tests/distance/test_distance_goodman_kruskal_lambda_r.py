...
cmp_no_d = GoodmanKruskalLambdaR(alphabet=0)


def test_goodman_kruskal_lambda_r_sim():
...
def test_goodman_kruskal_lambda_r_dist():
...
def test_goodman_kruskal_lambda_r_corr():
