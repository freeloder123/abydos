...
"""abydos.tests.distance.test_distance_tarantula.

This module contains unit tests for abydos.distance.Tarantula
"""


import pytest

from abydos.distance import Tarantula


cmp = Tarantula()

cmp_no_d = Tarantula(alphabet=0)


def test_tarantula_sim():
    """Test abydos.distance.Tarantula.sim."""
    # Base cases
    assert cmp.sim('', '') == 1.0
    ...
    assert cmp.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.9939382807)
    ...
    assert cmp_no_d.sim('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.3888888889)

def test_tarantula_dist():
    """Test abydos.distance.Tarantula.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
    ...
    assert cmp.dist('Nigel', 'Niall') == pytest.approx(abs=1e-7, expected=0.0076530612)
    assert cmp.dist('Niall', 'Nigel') == pytest.approx(abs=1e-7, expected=0.0076530612)
    assert cmp.dist('Colin', 'Coiln') == pytest.approx(abs=1e-7, expected=0.0076530612)
    assert cmp.dist('Coiln', 'Colin') == pytest.approx(abs=1e-7, expected=0.0076530612)
    assert cmp.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.0060617193)
    ...
    assert cmp_no_d.dist('ATCAACGAGT', 'AACGATTAG') == pytest.approx(abs=1e-7, expected=0.6111111111)
