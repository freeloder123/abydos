...
def test_rogot_goldberg_sim():
    """Test abydos.distance.RogotGoldberg.sim."""
    # Base cases
    assert cmp.sim('', '') == 1.0
    assert cmp.sim('a', '') == 0.49936143039591313
    assert cmp.sim('', 'a') == 0.49936143039591313
    assert cmp.sim('abc', '') == 0.49872122762148335
    assert cmp.sim('', 'abc') == 0.49872122762148335
    ...
    assert cmp_no_d.sim('a', '') == 0
    assert cmp_no_d.sim('', 'a') == 0
    assert cmp_no_d.sim('abc', '') == 0
    assert cmp_no_d.sim('', 'abc') == 0
    assert cmp_no_d.sim('abc', 'abc') == 1.0
    assert cmp_no_d.sim('abcd', 'efgh') == 0
...
def test_rogot_goldberg_dist():
    """Test abydos.distance.RogotGoldberg.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
    assert cmp.dist('a', '') == 0.5006385696040869
    assert cmp.dist('', 'a') == 0.5006385696040869
