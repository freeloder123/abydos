...
def test_sift4_simplest_dist_abs():
    ...
    assert cmp.dist_abs('abcdefg', 'xabxcdxxefxgx') == 10

    assert cmp.dist_abs('ab', 'b') == 1
    assert cmp.dist_abs('ab', 'a') == 1
    assert cmp.dist_abs('abc', 'ac') == 1
    assert cmp.dist_abs('xabxcdxxefxgx', 'abcdefg') == 10
    ...
    assert cmp.dist_abs('sturgeon', 'urgently') == 4
    assert cmp.dist_abs('levenshtein', 'frankenstein') == 10
    assert cmp.dist_abs('distance', 'difference') == 7
    ...
    assert (
        Sift4Simplest(5).dist_abs( 'This is the first string', 'And this is another string' )
        == 13
    )
    assert (
        Sift4Simplest(10).dist_abs( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'Amet Lorm ispum dolor sit amet, consetetur adixxxpiscing' + ' elit.', )
        == 20
    )
