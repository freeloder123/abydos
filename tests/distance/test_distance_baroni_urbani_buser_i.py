...
"""abydos.tests.distance.test_distance_baroni_urbani_buser_i.

This module contains unit tests for abydos.distance.BaroniUrbaniBuserI
"""


import pytest

from abydos.distance import BaroniUrbaniBuserI


cmp = BaroniUrbaniBuserI()

cmp_no_d = BaroniUrbaniBuserI(alphabet=0)


def test_baroni_urbani_buser_i_sim():
...
def test_baroni_urbani_buser_i_dist():
    """Test abydos.distance.BaroniUrbaniBuserI.dist."""
    # Base cases
    assert cmp.dist('', '') == 0.0
