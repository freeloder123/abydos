...
def test_occurrence_fingerprint():
    """Test abydos.fingerprint.Occurrence."""
    # Base case
    assert fp.fingerprint('') == '0' * 16

    # https://arxiv.org/pdf/1711.08475.pdf
    assert fp.fingerprint('instance') == '1110111000010000'

    assert fp.fingerprint('inst') == '0100111000000000'
    assert Occurrence(15).fingerprint('instance') == '111011100001000'
    assert (
